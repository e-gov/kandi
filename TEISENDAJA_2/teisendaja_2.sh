...
# Suudab töödelda KOV 2021 faile. Teiste valimissündmuste tüüpide failide formaat erineb.

# Kasutamine: ./teisendaja_2.sh <sisendfail> <väljundfail>
...
# Nt: ./teisendaja_2.sh ../ANDMED/KANDIDAADID_2021.json ../ANDMED/KANDIDAADID_2021.csv
